...
<!-- Carousel -->
<link href="{$WEB_ROOT}/templates/{$template}/css/owl.carousel.css" rel="stylesheet">
<link href="{$WEB_ROOT}/templates/{$template}/css/owl.theme.css" rel="stylesheet">
<!-- jQuery -->
...
{if !empty($mdeLocale)} {$mdeLocale} {/if} {/if} {if $templatefile == "viewticket" && !$loggedin}
